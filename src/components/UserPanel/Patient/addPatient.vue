...
import General_Info                         from '@/components/UserPanel/Patient/new/General_Info.vue'
import Nutritional_Assessment               from '@/components/UserPanel/Patient/new/Nutritional_Assessment.vue'
import Bio_Chemistry                        from '@/components/UserPanel/Patient/new/Bio_Chemistry.vue'
import Medications_Supplements              from '@/components/UserPanel/Patient/new/Medications_Supplements.vue'
import PatientAnthropometry                 from '@/components/UserPanel/Patient/new/Patient_Anthropometry.vue'
import GI_Function                          from '@/components/UserPanel/Patient/new/GI_Function.vue'
import Diet_History                         from '@/components/UserPanel/Patient/new/Diet_History.vue'
import Navigator                            from '@/components/UserPanel/Patient/new/myNavigator.vue'
import Buttons                              from '@/components/UserPanel/Patient/new/newButtons.vue'
